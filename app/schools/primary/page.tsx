...
const div = DIVISIONS[2];
export const metadata = { title: "Primary School", description: "Learn about the Primary School at Cecilia Learning Academy, Port Harcourt." };
export default function Page() {
  return (
    <>
      <PageHero title={div.label} subtitle={div.ageRange} breadcrumb={[{ label: "Schools", href: "/schools" }, { label: div.label, href: "/schools/primary" }]} />
