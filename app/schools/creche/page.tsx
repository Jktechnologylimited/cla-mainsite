...
export const metadata = { title: "Crèche", description: "Learn about the Crèche at Cecilia Learning Academy, Port Harcourt." };
export default function Page() {
  return (
    <>
      <PageHero title={div.label} subtitle={div.ageRange} breadcrumb={[{ label: "Schools", href: "/schools" }, { label: div.label, href: "/schools/creche" }]} />
