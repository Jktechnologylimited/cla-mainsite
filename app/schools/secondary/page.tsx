...
const div = DIVISIONS[3];
export const metadata = { title: "Secondary School", description: "Learn about the Secondary School at Cecilia Learning Academy, Port Harcourt." };
export default function Page() {
  return (
    <>
      <PageHero title={div.label} subtitle={div.ageRange} breadcrumb={[{ label: "Schools", href: "/schools" }, { label: div.label, href: "/schools/secondary" }]} />
