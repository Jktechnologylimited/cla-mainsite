...
const PAGE_URL = "https://cecilialearningacademy.com.ng/about";
const OG_IMAGE = "https://res.cloudinary.com/devdspz1m/image/upload/w_1200,h_630,c_fill,g_auto,q_auto,f_auto/v1781695454/PHOTO-2026-05-11-20-32-10_p2coxi.jpg";

export const metadata: Metadata = {
  title: "About Us — Our Mission, Vision & Story",
  description: "Learn about Cecilia Learning Academy — our mission, vision, core values, and 18+ year story of providing quality education in Rumuolumeni, Port Harcourt, Rivers State.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: "About Cecilia Learning Academy | Port Harcourt",
    description: "Discover our mission, vision, values, and 18+ year story of shaping young minds in Port Harcourt, Rivers State, Nigeria.",
    url: PAGE_URL,
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "CLA students learning together" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "About Cecilia Learning Academy | Port Harcourt",
    description: "Our mission, vision, values and story of quality education in Rumuolumeni, Port Harcourt.",
    images: [OG_IMAGE],
  },
};
...
export default async function AboutPage() {
  ...
  return (
    <>
      <PageHero title="About Cecilia Learning Academy"
        subtitle="A legacy of excellence, a heart for every child."
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={label} className="p-8 border border-ivory-dark">
                <div className={`w-12 h-12 ${bg} flex items-center justify-center mb-5`}><Icon size={22} className={color} /></div>
            ...
            <div className="p-8 border border-ivory-dark">
              <div className="w-12 h-12 bg-yellow-50 flex items-center justify-center mb-5"><Star size={22} className="text-yellow-500" /></div>
              <div className="h-0.5 w-8 bg-crimson mb-4" />
              ...
              <ul className="space-y-2">
                {values.map((v: string, i: number) => (
                  <li key={i} className="flex items-start gap-2.5 text-sm text-slate">
                    <span className="w-1.5 h-1.5 bg-crimson rounded-full shrink-0 mt-1.5" />{v}
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-5 text-slate leading-relaxed text-[15px]">
                <p>{storyP1}</p><p>{storyP2}</p><p>{storyP3}</p>
              </div>
            ...
            <div className="relative overflow-hidden">
              <img src="https://res.cloudinary.com/devdspz1m/image/upload/w_900,h_700,c_fill,g_auto,q_auto,f_auto/v1781695454/PHOTO-2026-05-11-20-32-10_p2coxi.jpg"
                alt="CLA students in a creative learning activity" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-navy-dark/70" />
              <div className="absolute inset-0 p-10 flex flex-col justify-between">
                <div>
                  <p className="font-display text-white text-xl italic font-light leading-relaxed mb-3">&ldquo;{SCHOOL.tagline}&rdquo;</p>
      ...
      <div className="bg-crimson py-16 text-center px-6">
        <h2 className="font-display text-3xl font-bold text-white mb-3">{s.home_cta_title || "Ready to Join the CLA Family?"}</h2>
        <p className="text-white/75 mb-7 max-w-md mx-auto text-[15px]">{s.home_cta_subtitle || "Enrolment is open. Secure your child's place today."}</p>
